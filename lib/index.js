...
var imgur_1 = require("@rmp135/imgur");
...
var Imgur = /** @class */ (function () {
     ...
     */
    Imgur.prototype.upload = function (filepath) {
        return __awaiter(this, void 0, void 0, function () {
            var api, file_base64, link;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        api = new imgur_1.Client({ client_id: this.client_id });
                        file_base64 = fs_1.default.readFileSync(filepath)
                            .toString('base64');
                        return [4 /*yield*/, api.Image.upload(file_base64, {
                                type: 'base64',
                                title: filepath
                            })];
                    case 1:
                        link = (_a.sent()).data.link;
